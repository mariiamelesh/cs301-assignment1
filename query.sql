with user_amount_by_organization as (
	...
	big_organizations.industry, 
	role, 
	count(login_logs.login_id) as failed_login_count
	...
	(select big_organizations.org_id, 
	big_organizations.industry, 
	systems.os_type, 
	...
	group by big_organizations.org_id, 
	big_organizations.industry, 
	systems.os_type)
	...
	big_organizations.industry, 
	systems.os_type, 
	count(event_id) as incident_count
...
industry, 
role as error_source, 
failed_login_count as failure_count, 
